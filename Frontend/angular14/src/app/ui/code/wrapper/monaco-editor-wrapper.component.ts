...
export class MonacoEditorWrapperComponent implements ControlValueAccessor {
  ...
  set editorOptions(editorOptions: any) {
    if (this._componentInitialized) {
      ...
      if (this._editorOptions != editorOptions.language) {
        this._webview.send("setLanguage", editorOptions.language);
      }
    }
  ...
  ngAfterViewInit(): void {
    ...
    editorHTML = `<!DOCTYPE html>
            ...
            }" style="width:100%;height:100%;${this._editorStyle}"></div>
            <script>
            ...
            <script>
                ...
                ipcRenderer.on('setEditorOptions', function(event, data){
                    monaco.editor.updateOptions(data);
