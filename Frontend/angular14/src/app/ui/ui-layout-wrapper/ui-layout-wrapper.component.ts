...
export class UILayoutWrapperComponent {
  ...
  async ngOnChanges(changes: SimpleChanges) {
      ...
      if (obj.has(this, "uiElement.init")) {
        if (this.copy) {
          let element = JSON.parse(
            JSON.stringify(obj.has(this, "uiElement.init"))
          );
    ...
    if (this.componentRef) {
      this.componentRef.instance.uiElement = JSON.parse(
        JSON.stringify(this.uiElement)
      );
  ...
  findComponentFactory(type) {
    ...
    switch (type) {
      ...
      case "code-editor":
        componentFactory =
          this.cfr.resolveComponentFactory(CodeEditorComponent);
        break;
      case "popup-menu":
      ...
      case "progress":
        componentFactory =
          this.cfr.resolveComponentFactory(ProgressBarComponent);
        break;
      case "form-generator":
      ...
      case "typography":
        componentFactory =
          this.cfr.resolveComponentFactory(TypographyComponent);
        break;
      case "signature":
