...
export class SignatureComponent extends BaseComponent {
  ...
  ngAfterViewInit() {
    ...
    else this.signaturePad.set("canvasHeight", 200);

    // set background color
    if (this.uiElement.backgroundColor)
      this.signaturePad.set("backgroundColor", this.uiElement.backgroundColor);
    else this.signaturePad.set("backgroundColor", "#E2E2E2");

    // set pen color
    if (this.uiElement.penColor)
      this.signaturePad.set("penColor", this.uiElement.penColor);
