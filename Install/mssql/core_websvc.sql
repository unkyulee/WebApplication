IF OBJECT_ID('dbo.core_websvc', 'U') IS NULL
BEGIN
    CREATE TABLE core_websvc (
        _id int IDENTITY(1,1) PRIMARY KEY,
        navigation_id int NOT NULL,
        api_url NVARCHAR(255) NOT NULL,
        description NVARCHAR(255),
        get_description NVARCHAR(255),
        get_configuration NVARCHAR(MAX),
        get_datasource INT,
        get_workflow INT,
        post_description NVARCHAR(255),
        post_configuration NVARCHAR(MAX),
        post_datasource INT,
        post_workflow INT,
        put_description NVARCHAR(255),
        put_configuration NVARCHAR(MAX),
        put_datasource INT,
        put_workflow INT,
        delete_description NVARCHAR(255),
        delete_configuration NVARCHAR(MAX),
        delete_datasource INT,
        delete_workflow INT,
...
SET IDENTITY_INSERT core_websvc ON;

IF EXISTS(SELECT * FROM core_websvc WHERE _id = 1) DELETE FROM core_websvc WHERE _id = 1
...
IF EXISTS(SELECT * FROM core_websvc WHERE _id = 20) DELETE FROM core_websvc WHERE _id = 20
INSERT INTO core_websvc (_id, navigation_id, api_url, description,
  get_description, get_configuration, get_datasource, get_workflow,
  post_description, post_configuration, post_datasource, post_workflow,
  put_description, put_configuration, put_datasource, put_workflow,
...
IF EXISTS(SELECT * FROM core_websvc WHERE _id = 30) DELETE FROM core_websvc WHERE _id = 30
INSERT INTO core_websvc (_id, navigation_id, api_url, description,
  get_description, get_configuration, get_datasource, get_workflow,
  post_description, post_configuration, post_datasource, post_workflow,
  put_description, put_configuration, put_datasource, put_workflow,
...
IF EXISTS(SELECT * FROM core_websvc WHERE _id = 40) DELETE FROM core_websvc WHERE _id = 40
INSERT INTO core_websvc (_id, navigation_id, api_url, description,
  get_description, get_configuration, get_datasource, get_workflow,
  post_description, post_configuration, post_datasource, post_workflow,
  put_description, put_configuration, put_datasource, put_workflow,
  ...
  'Get', '
{
  sql: "
    SELECT {fields}
    FROM core_websvc W
      INNER JOIN core_navigation N ON N._id = W.navigation_id
    {where}"
  , admin: true
  , id: "W._id"
...
IF EXISTS(SELECT * FROM core_websvc WHERE _id = 50) DELETE FROM core_websvc WHERE _id = 50
INSERT INTO core_websvc (_id, navigation_id, api_url, description,
  get_description, get_configuration, get_datasource, get_workflow,
  post_description, post_configuration, post_datasource, post_workflow,
  put_description, put_configuration, put_datasource, put_workflow,
...
IF EXISTS(SELECT * FROM core_websvc WHERE _id = 60) DELETE FROM core_websvc WHERE _id = 60
INSERT INTO core_websvc (_id, navigation_id, api_url, description,
  get_description, get_configuration, get_datasource, get_workflow,
  post_description, post_configuration, post_datasource, post_workflow,
  put_description, put_configuration, put_datasource, put_workflow,
...
IF EXISTS(SELECT * FROM core_websvc WHERE _id = 70) DELETE FROM core_websvc WHERE _id = 70
INSERT INTO core_websvc (_id, navigation_id, api_url, description,
  get_description, get_configuration, get_datasource, get_workflow,
  post_description, post_configuration, post_datasource, post_workflow,
  put_description, put_configuration, put_datasource, put_workflow,
...
IF EXISTS(SELECT * FROM core_websvc WHERE _id = 71) DELETE FROM core_websvc WHERE _id = 71
INSERT INTO core_websvc (_id, navigation_id, api_url, description,
  post_description, post_configuration, post_datasource, post_workflow)
...
IF EXISTS(SELECT * FROM core_websvc WHERE _id = 72) DELETE FROM core_websvc WHERE _id = 72
INSERT INTO core_websvc (_id, navigation_id, api_url, description,
  post_description, post_configuration, post_datasource, post_workflow)
...
IF EXISTS(SELECT * FROM core_websvc WHERE _id = 80) DELETE FROM core_websvc WHERE _id = 80
INSERT INTO core_websvc (_id, navigation_id, api_url, description,
  get_description, get_configuration, get_datasource, get_workflow,
  post_description, post_configuration, post_datasource, post_workflow,
  put_description, put_configuration, put_datasource, put_workflow,
...
IF EXISTS(SELECT * FROM core_websvc WHERE _id = 90) DELETE FROM core_websvc WHERE _id = 90
INSERT INTO core_websvc (_id, navigation_id, api_url, description,
  get_description, get_configuration, get_datasource, get_workflow,
  post_description, post_configuration, post_datasource, post_workflow,
  put_description, put_configuration, put_datasource, put_workflow,
...
IF EXISTS(SELECT * FROM core_websvc WHERE _id = 100) DELETE FROM core_websvc WHERE _id = 100
INSERT INTO core_websvc (_id, navigation_id, api_url, description,
  get_description, get_configuration, get_datasource, get_workflow,
  post_description, post_configuration, post_datasource, post_workflow,
  put_description, put_configuration, put_datasource, put_workflow,
...
SET IDENTITY_INSERT core_websvc OFF;