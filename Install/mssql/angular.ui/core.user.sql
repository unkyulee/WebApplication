...
IF EXISTS(SELECT * FROM angular_ui WHERE _id = 130) DELETE FROM angular_ui WHERE _id = 130
...
IF EXISTS(SELECT * FROM angular_ui WHERE _id = 2) DELETE FROM angular_ui WHERE _id = 2
INSERT INTO angular_ui (_id, content)
VALUES (2, '
